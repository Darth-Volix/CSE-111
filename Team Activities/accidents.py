    ...
    try:
      ...
      with open(filename, "rt") as text_file:
            ...
            if perc_reduc > 100 or perc_reduc < 0:
                print("Error, the input you entered was greater than 100 or less than 0."\
        ...
        # This code will be executed if the user enters
        # an invalid integer that can't be converted to a float.
        print()
        print(type(val_err).__name__, val_err, sep=": ")
        print("The percentage entered is invalid and can't" \
              " be converted to a float. Please rerun the\n" \
                "program and try again.")
        
    except ZeroDivisionError as zero_div_error:
        # This code will be executed if the code
        # encounters a division by 0.
        print()
        print(type(zero_div_error).__name__, zero_div_error, sep=": ")
        print(f"Error: line {reader.line_num} of" \
